...
entry:
  ...
  %call = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0))
  ret i32 0
}
...
!0 = metadata !{metadata !"clang version 3.5 (https://github.com/securesystemslab/multicompiler-clang.git 3319fd4e4f4ea468159ce5377f4c5a501b2eeeb7) (https://github.com/securesystemslab/multicompiler.git 1ca4edd441ed190ebe42becedf833ec50bf2fc65)"}
