...
public:
  ...
  static std::string CurrentMapLabel;//SNEISIUS
  static unsigned CurrentMapInstr;//SNEISIUS

  /// Create a MachineInstrBuilder for manipulating an existing instruction.
  /// F must be the machine function  that was used to allocate I.
  MachineInstrBuilder(MachineFunction &F, MachineInstr *I) : MF(&F), MI(I) {
    //errs() << "************************" << MachineInstrBuilder::CurrentMapLabel <<":" << MachineInstrBuilder::CurrentMapInstr <<"\n";
    std::ostringstream label;
    label << MachineInstrBuilder::CurrentMapLabel << ":" << MachineInstrBuilder::CurrentMapInstr++;
    MI->setMapLabel(label.str());
  }
  ...
  static void setCurrentMapLabel(std::string label){//SNEISIUS
    std::ostringstream temp;
    MachineInstrBuilder::CurrentMapLabel = label;
    MachineInstrBuilder::CurrentMapInstr = 0;
  }
  const MachineInstrBuilder &setMapLabel(std::string label) const{//SNEISIUS
    MI->setMapLabel(label);
    return *this;
  }//
