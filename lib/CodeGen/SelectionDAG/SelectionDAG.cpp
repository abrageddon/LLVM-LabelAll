...
void SelectionDAG::ReplaceAllUsesWith(SDValue FromN, SDValue To) {
  ...
  //SNEISIUS
  if(From->getMapLabel().size() !=0){
    errs()<<"SelectionDAG::ReplaceAllUsesWith: "<<From->getMapLabel() << "\n";
    To.getNode()->setMapLabel(From->getMapLabel());
  }
...
void SelectionDAG::ReplaceAllUsesWith(SDNode *From, SDNode *To) {
  ...
  if(From->getMapLabel().size() !=0){
    errs()<<"SelectionDAG::ReplaceAllUsesWith: "<<From->getMapLabel() << "\n";
    To->setMapLabel(From->getMapLabel());
  }
...
void SelectionDAG::ReplaceAllUsesOfValuesWith(const SDValue *From,
  ...
  for (unsigned i = 0; i != Num; ++i) {
    ...
    //SNEISIUS
    if(FromNode->getMapLabel().size() !=0){
      errs()<<"SelectionDAG::ReplaceAllUsesWith: "<<FromNode->getMapLabel() << "\n";
      To[i]->setMapLabel(FromNode->getMapLabel());
    }
...
void SelectionDAG::TransferDbgValues(SDValue From, SDValue To) {
  ...
  //SNEISIUS
  if(From->getMapLabel().size() !=0){
    errs()<<"SelectionDAG::TransferDbgValues: "<<From->getMapLabel() << "\n";
    To->setMapLabel(From->getMapLabel());
  }
